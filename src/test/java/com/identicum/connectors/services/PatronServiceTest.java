...
public class PatronServiceTest {
    ...
    @Test
    void testCreatePatron_409_allFieldsPresent_noMatch_throwsAlreadyExists() throws Exception {
        // Con cardnumber/userid/email presentes pero sin match en ninguno -> relanza 409.
        // (D-14: retirado el adopt-by-DNI legacy; la idempotencia es solo por campos unicos REST.)
